...
public class QABoardController {
	...
	public ModelAndView replyf(ModelAndView mv, QABoardVO vo) {
	...
	public ModelAndView reply(ModelAndView mv, QABoardVO vo, RedirectAttributes rttr) {
		// ** 답글 입력 Service
		// => 성공 : blist
		// => 실패 : 재입력 유도 (replyForm) 
	...
	public ModelAndView blist(ModelAndView mv) {
		...
		List<QABoardVO> list = service.selectList() ;
		if (list != null) {
	...
	public ModelAndView binsert(ModelAndView mv, QABoardVO vo, RedirectAttributes rttr) {
	...
	public ModelAndView bupdate(ModelAndView mv, QABoardVO vo, RedirectAttributes rttr) {
