		...
		<div class="container">
			...
			<div class="w3_search">
				<form action="search" method="post">
					<input type="text" name="keyword" placeholder="영화/감독" value="${keyword}">
...
<!-- general -->
	<div class="general">
		<h4 class="latest-text w3_latest_text">영화 검색</h4>
				...
				<div class="agileits-news-top">
					...
					<div class="agile-news-table">
							<div class="w3ls-news-result">
									...
									<h4><b>${keyword}</b> 검색 결과 : <span>${searchResult} 건의 영화를 찾았습니다.</span></h4>
								...
								<tbody>
								  <c:forEach var="list" items="${movieList}" varStatus="status">
									<c:choose>
										...
										<tr>
									 		<td>${status.index+1}</td>
											<td class="w3-list-img"><a href="mvdetail?movie_num=${list.movie_num}&searchType=n"><img src="${list.posterfile}"  style="width: 46px; height: 69px;"/> <span>${list.movie_title}</span></a></td>
											<td>${list.release}</td>
											<td>${list.director}</td>
											<td>${list.rate_avg}</td>
										</tr>				
