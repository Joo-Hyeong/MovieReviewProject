...
<!-- general -->
	<div class="general">
		<h4 class="latest-text w3_latest_text">${Movie.movie_title}</h4>
		...
		<div class="container">
					...
					<!-- 영화 상세탭 -->
					<div>
						<img src="${Movie.posterfile}" width=200px; height=300px;><br><br>
						
						<form action="editMovie" method="post" enctype="multipart/form-data">
						<input type="text" value="${Movie.movie_num}" name="movie_num" hidden="">
						
						<div class="input-group w3_w3layouts">
							<span class="input-group-addon" id="basic-addon1" style="width:60px">제목</span>
							<input type="text" class="form-control" placeholder="Username" aria-describedby="basic-addon1" name="movie_title" value="${Movie.movie_title}"  style="width:300px">
						</div>
	
						<div class="input-group w3_w3layouts">
							<span class="input-group-addon" id="basic-addon2" style="width:60px">감독</span>
							<input type="text" class="form-control" placeholder="Username" aria-describedby="basic-addon1" name="director" value="${Movie.director}" style="width:300px">
						</div>
	
						<div class="input-group w3_w3layouts">
							<span class="input-group-addon" id="basic-addon3" style="width:60px">배우</span>
						<c:forEach var="list" items="${Actors}">
							<input type="text" class="form-control" value="${list.actor}" name="actor" readonly="readonly"><br>
						</c:forEach>
						...
						<div class="input-group w3_w3layouts">
							...
							<input type="date" class="form-control" placeholder="Username" aria-describedby="basic-addon1" value="${Movie.release}" name="release" style="width:300px">
						</div>
	
						<div class="input-group w3_w3layouts">
							<span class="input-group-addon" id="basic-addon2" style="width:60px">예고편</span>
							<input type="text" class="form-control" placeholder="Username" aria-describedby="basic-addon1" value="${Movie.trailer}" name="trailer" style="width:300px">
						</div>
						
						<div class="input-group w3_w3layouts">
							<span class="input-group-addon" id="basic-addon2" style="width:60px">포스터</span>
							<input type="file" class="form-control" placeholder="기존 포스터 등록" aria-describedby="basic-addon1" name="posterfilef"  style="width:300px">
						</div>
