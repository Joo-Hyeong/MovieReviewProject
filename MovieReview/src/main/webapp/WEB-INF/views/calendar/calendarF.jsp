...
<link href='resources/library/fcLib/fullcalendar.min.css' rel='stylesheet' />
<link href='resources/library/fcLib/fullcalendar.print.min.css'
   rel='stylesheet' media='print' />

<script src='resources/library/fcLib/moment.min.js'></script>
<script src='resources/library/fcLib/fullcalendar.min.js'></script>
<!-- 한글화 위해 추가 -->
<script src='resources/library/fcLib/ko.js'></script>
<script src='resources/library/fcLib/jquery.bpopup.min.js'></script>
<link
       ...
       eventDrop: function(event, delta, revertFunc){
         ...
         $.ajax({
            ...
            success: function (data) {
               ...
               location.href = 'http://localhost:8080/project/calendarF';
            } // success
         }) // ajax
      },   // eventDrop  
