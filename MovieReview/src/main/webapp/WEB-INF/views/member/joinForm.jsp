...
<!-- general -->
	<div class="general">
		<h4 class="latest-text w3_latest_text">회원가입 양식</h4>
		<div class="container">
	...
	<div>
		...
		<span>
			<input type="text" id="joinId" name="id">&nbsp;
		</span>
	...
	<!-- 아직 미구현 입니다. -->
		...
		<span>
			...
			<input type="text" id="domain" name="domain" readonly="true" size=15 placeholder="- 주소 선택 -">
			<select id="domainf">
